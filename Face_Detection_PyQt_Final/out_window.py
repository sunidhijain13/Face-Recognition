                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                self.MinLabel.setText("{:.0f}".format(abs(self.ElapseHours.total_seconds() / 60)%60) + 'min')
                                self.HoursLabel.setText("{:.0f}".format(abs(self.ElapseHours.total_seconds() / 60**2)) + 'hour')
